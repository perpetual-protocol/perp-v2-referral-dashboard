...
export default function MyTrading(props: Props) {
    ...
    const stakeMoreText = nextRefereeTier
        ? `Stake ${nextRefereeTier?.staked} PERP to reach the next tier and unlock more rewards.`
        : ""
        ...
        <>
            {!isReferee && (
                <Modal>
                    ...
                    {!referralCodeExists && (
                        <span className="text-perp-red text-sm">This referral code does not exist.</span>
                    )}
                    <div className="mt-4">
            ...
            <StatCard icon={<PerpLogoGreen />} value={Number(data)} title="Staked Perp" isLoading={isLoadingData} />
            <StatCard
                icon={<USDCLogo />}
            ...
            <StatCard
                ...
                tooltip={
                    <div className="flex flex-col w-52">
                        ...
                        <span>
                            The more transactions you make, the more in PERP rewards you will get, and the rewards will
                            be credited to your account every week.
                        </span>
                    </div>
                }
                state={cardState}
            ...
            <div className="col-span-12 mb-8">
                ...
                {isLoadingData && <Skeleton height={350} className="bg-perp-gray-300 rounded-2xl p-4" />}
                {!isLoadingData && (
