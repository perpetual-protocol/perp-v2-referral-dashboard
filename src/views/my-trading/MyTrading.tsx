    ...
    <>
      ...
      <StatCard
        ...
        tooltip={
          <div className="flex flex-col w-52">
            ...
            <span>
              The more transactions you make, the more perps rewards you will
              get, and the rewards will be credited to your account every week.
            </span>
          </div>
        }
        state={cardState}
      ...
      <div className="col-span-12 sm:col-span-6">
        ...
        <p className="text-perp-gray-50 mb-4">
          ...
          use for trading. Please see caps (in USD) for each staking tier on the
          right. Keep in mind that all rewards are paid in PERP.
        </p>
