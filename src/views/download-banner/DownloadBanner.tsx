...
export default function DownloadBanner(props: unknown) {
    ...
    useEffect(() => {
        ...
        setUrl(`${urlPrefix}?refCode=${referralCode}&shape=${shape}&discount=${discount}`)
    }, [shape, referralCode, vipTier])
            ...
            <div className="flex flex-col self-center justify-center items-center w-full h-full font-body subpixel-antialiased">
                ...
                {canAccessApp && (
                    <div style={{ maxWidth: "1200px" }}>
                        <div>
                            <h1 className="text-white text-2xl font-bold">Generate Referral Code Banner</h1>
                            <p className="text-perp-gray-200">Select a shape and download a special banner.</p>
                            ...
                            <div>
                                <img alt="" height="500" width="500" src={url} />
                            </div>
                        </div>
                    </div>
                )}
