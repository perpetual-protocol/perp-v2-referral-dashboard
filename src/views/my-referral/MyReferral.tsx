        ...
        <>
          ...
          <div className="col-span-12 sm:col-span-6">
            ...
            <p className="text-perp-gray-50 mb-4">
              You can increase your weekly caps by staking PERP with the address you use for trading. Please see caps (in USD) for each staking tier on the right. Keep in mind that all rewards are paid in PERP. Tier 3 and 4 require manual upgrade. Check with us on <a href="https://discord.perp.fi/" target="_blank">Discord</a> to proceed. 
            </p>
